...
\newcommand{\No}{№}
\newcommand{\zt}{\tilde z}
\newcommand{\en}{e} % environment
\renewcommand{\c}{\circ} % cavity
\renewcommand{\s}{\odot} % sphere
\renewcommand{\l}{\circledcirc} % layer
\newcommand{\hre}{\hat\r_\en}
\newcommand{\hfe}{\hat\f_\en}
\newcommand{\hrc}{\hat\r_\c}
\newcommand{\hfc}{\hat\f_\c}
