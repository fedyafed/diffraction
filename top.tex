...
\newcommand{\No}{№}
\newcommand{\zt}{\tilde z}
\newcommand{\en}{_e} % environment
\renewcommand{\o}{_o} % outgoing
\renewcommand{\sc}{_s} % scattered
\renewcommand{\c}{_\circ} % cavity
\newcommand{\s}{_\odot} % sphere
\renewcommand{\l}{_\circledcirc} % layer
\newcommand{\hre}{\hat\r\en}
\newcommand{\hfe}{\hat\f\en}
\newcommand{\hrc}{\hat\r\c}
\newcommand{\hfc}{\hat\f\c}
