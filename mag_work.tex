...
\sin\Q \, L(B) = 0.
\end{equation*}
Так как $\Q\in [0,2\pi),$ в полученных уравнениях опускаем множитель $\sin\Q.$ 
...
\begin{align}
L\!\left(\fr{{u\l}_r-{u\l}_2}{r\s} + \fr{\de {u\l}_2}{\de r\s}\right)&\Biggr|_{r\s = R\l} = 0.\label{eq_Rl.3a}\\
L\!\left(\fr{\de {u\l}_3}{\de r\s} - \fr{{u\l}_3}{r\s}\right)&\Biggr|_{r\s = R\l} = 0.\label{eq_Rl.4a}
\end{align}
...
\begin{align}
\mu\l L\!\left(\fr{{u\l}_r-{u\l}_2}{r\s} + \fr{\de {u\l}_2}{\de r\s}\right) &= \mu\s L\!\left(2\fr{\de}{\de r\s}\left(\fr{\P\s}{r\s}\right)+  \fr{\de^2 W}{\de r\s^2} - \fr{L(W) + 2W}{r\s^2} \right);\\
\mu\l L\!\left(\fr{\de {u\l}_3}{\de r\s} - \fr{{u\l}_3}{r\s}\right) &= \mu\s r\s\fr{\de}{\de r\s}L\!\left(\fr{V}{r\s}\right);\\
L({u\l}_2) &= \fr{1}{r\s}L\!\left(\P\s + \fr{\de}{\de r\s}\biggl(r\s W\biggr)\right);\\
L({u\l}_3) &= L(V).
\end{align}
...
\begin{align}
\mu\s L\!\left(2\fr{\de}{\de r\c}\left(\fr{\P\s}{r\c}\right) + \fr{\de^2 W}{\de r\c^2} - \fr{L(W) + 2W}{r\c^2}\right)&\Biggr|_{r\c=R\c}=0;\\
\mu\s r\c\fr{\de}{\de r\c}L\!\left(\fr{V}{r\c}\right)&\Biggr|_{r\c=R\c} = 0
\end{align}
