...
\end{split}\\
\begin{split}
&\fr{\mu\l}{r\s\sin\Q\s} \fr{\de {u\l}_r}{\de\f} - \fr{\mu\l}{r\s}\left(\df1{\sin\Q\s}\df{\de {u\l}_2}{\de\f\s} - \df{\de {u\l}_3}{\de\Q\s}\right) + \mu\l\fr{\de}{\de r\s}\left(\df1{\sin\Q\s}\df{\de {u\l}_2}{\de\f\s} - \df{\de {u\l}_3}{\de\Q\s} \right) = \\
= &\text{\todo{Add right side}}
\end{split}
\end{align}\\
\begin{align}
